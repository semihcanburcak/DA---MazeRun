...
public class WaypointPatrol : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {                                                                       //if remaining distance to the destination is less than the stopping distance
            m_CurrentWaypointIndex = (m_CurrentWaypointIndex + 1) % waypoints.Length; //The remainder operator takes whatever is to its left and divides it by whatever is to its right, then returns the remainder
